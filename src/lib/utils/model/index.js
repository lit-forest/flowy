import { curry, compose, hashedFns, reduce } from '../fun'
import { or } from '../fun'
import { flip } from '../fun'
import { isNothing, Maybe } from '../fp/Maybe'
...
export const Store = state => ({ ...modelFunctions(Store, state) })

const state = Store({ a: 'a' }).assignState({ b: 'b' })

console.log(state.getProp('a'))